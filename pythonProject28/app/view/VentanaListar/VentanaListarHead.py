...
class VentanaListarHead(Frame):
    ...
    def create_widgets(self):
        ...
        label_superior = Label(self, text='Inserción de registros', bg='SteelBlue3',font=tkinter.font.Font(family="Lucia Grande bold", size=20))
