...
class VentanaInsertarTabla(Frame):
    ...
    def create_widgets(self):
        self.table_insertar = ttk.Treeview(self, columns=("col1", "col2", "col3", "col4", "col5", 'col6'),
                                               show='headings')
        self.table_insertar.column("col1", width=10, anchor=CENTER)
        self.table_insertar.column("col2", width=140, anchor=CENTER)
        self.table_insertar.column("col3", width=50, anchor=CENTER)
        self.table_insertar.column("col4", width=82, anchor=CENTER)
        self.table_insertar.column("col5", width=65, anchor=CENTER)
        self.table_insertar.column("col6", width=230, anchor=CENTER)
        self.table_insertar.heading("col1", text="ID", anchor=CENTER)
        self.table_insertar.heading("col2", text="Referencia", anchor=CENTER)
        self.table_insertar.heading("col3", text="Turno", anchor=CENTER)
        self.table_insertar.heading("col4", text="Fecha", anchor=CENTER)
