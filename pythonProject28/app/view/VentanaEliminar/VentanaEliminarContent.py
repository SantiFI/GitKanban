...
class VentanaEliminarContent(Frame):
    ...
    def create_widgets(self):
        self.campo_eliminar = Entry(self, width=30, font='Arial 24', relief=SUNKEN, bg='white smoke')
        self.campo_eliminar.focus_force()
        self.campo_eliminar.grid(column = 0, sticky = 'nsew', padx=30, pady=10)